...
| 子目录 | 笔记数 | 内容 |
|--------|--------|------|
| `01.Linux环境` | **6** | 常用指令 · 动态库与静态库 · rpath · 加载与劫持 · grep · Linux 目录结构 |
| `02.Linux系统编程` | **8** | 进程管理 · CPU 亲和性 · 用户态/内核态 · 字符设备驱动 · 内核模块 · IPC · dup · popen/system |
| `03.Linux开发` | **4** | RK3588 · 交叉编译优化 · 容器化与系统构建 · Buildroot |
...
| `03.工具与配置` | 4 | 工具与配置索引 · /agent 使用指南 · Team 模式协作 · 模式对比与选型 |
...
- **总笔记数**：96 篇（截至 2026-06，7 大模块 A–G）
- **最大模块**：C-Linux生态（**44** 篇）
