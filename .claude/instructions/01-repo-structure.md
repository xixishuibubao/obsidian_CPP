...
|--------|--------|------|
| `01.C语言` | 2 | C 基础 · 底层原理 |
| `02.C++` | 6 | C++ OOP · 模板与泛型 · 代码规范 · 现代特性 · More Effective C++ · **C++ API 设计** |
| `03.Golang` | 1 | Go 语言基础 |
...
| 子目录 | 笔记数 | 内容 |
|--------|--------|------|
| `01.构建工具` | 8 | g++ · Makefile · CMake（入门/进阶）· 编译脚本设计 · 分布式编译 · 链接脚本 · **配置渲染与固件变体** |
| `02.脚本语言` | 3 | Shell · Python · **C/C++ 与 Python 互调用** |

### C-Linux生态（最大模块，6 个子目录）

| 子目录 | 笔记数 | 内容 |
|--------|--------|------|
| `01.Linux环境` | **9** | 常用指令 · 动态库与静态库 · rpath · 加载与劫持 · grep · Linux 目录结构 · 启动流程 · NFS · **Tailscale + SSH 远程转发** |
...
| `05.网络编程` | 1 | muduo 网络编程 |
| `06.开源项目分析` | **2** | 开源项目分析合集 · **mjpg-streamer** |
...
| `03.工具与配置` | **4** | /agent 使用指南 · Team 模式协作 · 模式对比与选型 · **Skill 总览与推荐清单** |
...
| 笔记 | 内容 |
|------|------|
| `1. Markdown.md` | Markdown + vault 特有规则 |
| `2. INI语法.md` | INI 配置 |
| `3. YAML语法.md` | YAML 配置 |
| `4. DOT与PlantUML绘图.md` | Graphviz DOT + PlantUML 架构/流程图 |
...
- **总笔记数**：87 篇（截至 2026-09，7 大模块 A–G）
- **最大模块**：C-Linux生态（**35** 篇）
