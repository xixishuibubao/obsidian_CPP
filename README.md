...
|:---:|:---:|:---:|
| 语法基础 · 代码规范 · 模板 · More Effective C++ · API 设计 | 常用指令 · g++/gdb · Makefile · 内核模块 · Tailscale+SSH | ARM32/64 · X86 汇编 · 内存模型 |
...
| 🤖 **AI 辅助开发** | 📝 **读书笔记** | 🎯 **更多专题** |
|:---:|:---:|:---:|
| 编程范式演进 · Vibecoding · Workflow 选型 | C++ 最佳实践 · API Design for C++ · 开源项目分析 | GC 算法 · 调试优化(10篇) · 架构设计(5篇) · Linux开发(5篇) |
