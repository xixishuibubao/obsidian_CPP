...
| 🗄️ **数据库** | 📝 **读书笔记** | 🎯 **更多专题** |
|:---:|:---:|:---:|
| SQL 语法 | More Effective C++ · 开源项目分析 | GC 算法 · 调试优化(6篇) · 架构设计(5篇) · 并发与多线程 |
...
📦 obsidian_files
├── 📁 00.Golang/               # Go 语言基础
├── 📁 01.C语法与技巧/           # C 语言 · 底层原理 · 系统编程
├── 📁 02.C++语法与要点/         # C++ 基础 · 代码规范 · 项目结构
├── 📁 03.Linux环境与工具/       # Vim · g++ · gdb · Makefile · 进程管理 · 内核模块（最大目录，15篇）
├── 📁 04.架构体系/              # ARM vs X86 架构 · 汇编
├── 📁 05.Win工具/               # MobaXterm · CLion · VS2022
├── 📁 06.Linux开发/             # RK3588 · Yocto 构建 · 交叉编译
├── 📁 07.数据库与SQL语法/       # 🚧 施工中
├── 📁 08.GUI与Qt/               # Qt 框架笔记
├── 📁 09.读书笔记/              # More Effective C++ 等
├── 📁 10.辅助语言/              # 脚本语言(Shell/Lua/CMake) · 标记/建模语言 · 英语词汇
├── 📁 11.MCU嵌入式/             # MCU 开发 · ARM32 内存注入
├── 📁 12.版本管理/              # Git 操作指南 · 提交规范
├── 📁 13.通讯协议/              # 🚧 施工中
├── 📁 14.技术杂谈/              # Hook 技术 · 插件架构设计
├── 📁 15.内存管理/              # GC 回收算法
├── 📁 16.数据结构与算法/        # 🚧 施工中
├── 📁 17.网络编程/              # Muduo · IO 模型 · Socket 编程
├── 📁 18.并发与多线程/          # atomic 内存序 · 线程与异步
├── 📁 19.异常处理/              # 🚧 施工中
├── 📁 20.模板操作/              # C++ 模板元编程
├── 📁 21.文件操作/              # 🚧 施工中
├── 📁 22.调试与优化/            # Perf · 基本调优 · 文件IO · 分支优化（6篇）
├── 📁 23.测试框架/              # 🚧 施工中
├── 📁 24.开源学习/              # 开源项目分析（Muduo/LevelDB/Redis/Nginx）
├── 📁 25.架构设计/              # PIMPL · CLI 设计 · 编译脚本 · Skill 方法论（5篇）
├── 📁 99.临时杂物间/            # 草稿笔记
├── 📁 picture/                  # 图片资源
├── 📁 readme/                   # 多语言 README
