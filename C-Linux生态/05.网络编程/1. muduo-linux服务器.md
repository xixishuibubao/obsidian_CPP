...
Muduo 是一个基于 Reactor 模式的 C++ 网络库。相关内容：

- [[C-Linux生态/05.网络编程/1. muduo-linux服务器|施磊 muduo 笔记]] — IO 模型分析、muduo 模块设计（日志、地址封装等）
- [[C-Linux生态/06.开源项目分析/1. 开源项目分析|开源项目分析：Muduo]] — Muduo 源码架构解析
- [[2. 服务器开源项目|服务器开源项目对比]] — Muduo 与其他服务器的对比