...
> 轻量级开源项目推荐，代码量从 1000 行到 1.5 万行，适合逐行精读。

## 1. 极简 STL 实现：tinystl（C++，8000 行）
...
## 2. 玩具级 Linux 内核：linux-0.11（C，1.5万行）
...
## 4. HTTP 解析器：http-parser（C，1200 行，Node.js 同款）
...
## 6. 轻量级内存池：tcmalloc-minimal（C++，2000 行）
...
## 7. 极简 Web 服务器：webserver（C++，5000 行，Linux 课设级）
